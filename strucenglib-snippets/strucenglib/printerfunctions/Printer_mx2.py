...
for variabel in variabeln:
    ...
    if variabel == "spezial":
        legende = ["Druckzoneniteration: Ein", "Druckzoneniteration: Aus", ]  # nx
    ...
    for se in sets:
        ...
        for resultat in resultate:
            ...
            for xx in x:
                ...
                zahl = 0
                inp1 = [1, xx * 1000, my[zahl], mxy[zahl], vx[zahl], vy[zahl],
                        ((vx[zahl] ** 2.0 + vy[zahl] ** 2.0) ** 0.5), nx[zahl], ny[zahl], nxy[zahl], h[zahl], 40, 40,
                ...
                zahl += 1
                inp2 = [2, xx * 1000, my[zahl], mxy[zahl], vx[zahl], vy[zahl],
                        ((vx[zahl] ** 2.0 + vy[zahl] ** 2.0) ** 0.5), nx[zahl], ny[zahl], nxy[zahl], h[zahl], 40, 40,
                        fck[zahl], theta[zahl], 435, alpha[zahl], alpha[zahl], beta[zahl], beta[zahl], se[0], se[1],
                        se[2], code, [1, 0, 0], [1, 0, 0], [0, 1, 0], [0, 0, 1]]
                zahl += 1
                inp3 = [3, xx * 1000, my[zahl], mxy[zahl], vx[zahl], vy[zahl],
                        ((vx[zahl] ** 2.0 + vy[zahl] ** 2.0) ** 0.5), nx[zahl], ny[zahl], nxy[zahl], h[zahl], 40, 40,
                        fck[zahl], theta[zahl], 435, alpha[zahl], alpha[zahl], beta[zahl], beta[zahl], se[0], se[1],
                        se[2], code, [1, 0, 0], [1, 0, 0], [0, 1, 0], [0, 0, 1]]
                ...
                zahl += 1
                inp4 = [4, xx * 1000, my[zahl], mxy[zahl], vx[zahl], vy[zahl],
                        ((vx[zahl] ** 2.0 + vy[zahl] ** 2.0) ** 0.5), nx[zahl], ny[zahl], nxy[zahl], h[zahl], 40, 40,
                        fck[zahl], theta[zahl], 435, alpha[zahl], alpha[zahl], beta[zahl], beta[zahl], se[0], se[1],
                        se[2], code, [1, 0, 0], [1, 0, 0], [0, 1, 0], [0, 0, 1]]
                zahl += 1
                inp5 = [5, xx * 1000, my[zahl], mxy[zahl], vx[zahl], vy[zahl],
                        ((vx[zahl] ** 2.0 + vy[zahl] ** 2.0) ** 0.5), nx[zahl], ny[zahl], nxy[zahl], h[zahl], 40, 40,
                        fck[zahl], theta[zahl], 435, alpha[zahl], alpha[zahl], beta[zahl], beta[zahl], se[0], se[1],
                        se[2], code, [1, 0, 0], [1, 0, 0], [0, 1, 0], [0, 0, 1]]
