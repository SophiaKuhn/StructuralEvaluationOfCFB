...
# Initialisieren
name = 'simplified_working_example'
path = 'C:\Temp\\'
...
concrete={'beton':2, 'fcc':40, 'vc':0, 'ecu':-0.002, 'k_E':10000, 'theta_b0':2, 'theta_b1':1, 'k_riss':0, 'Entfestigung':0, 'lambdaTS':0.67, 'srmx':1, 'srmy':1, 'Begrenzung':2, 'KritQ':0, 'winkelD':45, 'k_vr':1, 'fswy':500}
reinf_1L={'stahl':1,'zm':2,'fsy':700,'fsu':900,'esu':0.5,'esv':0.02,'Es':200000,'ka':-1,'kb':-1,'kc':-1,'as':7,'dm':20,'psi':90}
reinf_2L={'stahl':1,'zm':2,'fsy':700,'fsu':900,'esu':0.5,'esv':0.02,'Es':200000,'ka':-1,'kb':-1,'kc':-1,'as':7,'dm':20,'psi':0}
reinf_3L={'stahl':1,'zm':2,'fsy':700,'fsu':900,'esu':0.5,'esv':0.02,'Es':200000,'ka':-1,'kb':-1,'kc':-1,'as':7,'dm':20,'psi':0}
reinf_4L={'stahl':1,'zm':2,'fsy':700,'fsu':900,'esu':0.5,'esv':0.02,'Es':200000,'ka':-1,'kb':-1,'kc':-1,'as':7,'dm':20,'psi':90}
...
mdl.add(ShellSection(name='elset_deck_element_sec', t=300, semi_loc_coords=semi_loc_coords, nn=20))
...
mdl.add(AreaLoad(name='area_load_deck', elements=loaded_element_numbers,x=0,y=0,z=0.01)) 
...
GeneralStep(name='step_3',  loads=['area_load_deck'] ,   nlgeom=False, increments=1),
])
...
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
mdl.analyse_and_extract(software='ansys_sel', fields=[ 'u', 'eps' ], lstep = ['step_3']) 
