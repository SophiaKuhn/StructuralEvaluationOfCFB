...
#------------add geometry from Rhino file to structure object --------------------
...
# add elements to structure object
...
as1 = (d1**2 *m.pi)/(4*spacing) #[mm2/mm] 
as2 = (d2**2 *m.pi)/(4*spacing) 
...
#### Walls ####
#--read out sampled local parameters from the read in dict--# reinforcement geometry                
d1 = 14 #[mm]
d2 = 12 
d3 = 12
d4 = 24
...
save_to_pickle(obj=mdl,  file_name='structure') #folder_path=subfolder_path


# save results dict to a json file
res_dict=mdl.results
save_to_json(save_dict=res_dict, file_name='analysisResults') #folder_path=subfolder_path
