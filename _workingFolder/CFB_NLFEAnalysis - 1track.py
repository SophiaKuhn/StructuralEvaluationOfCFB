...
for curid in [300,301,302,303,304,305]:
    ...
    #    plot_nr_nodes(mdl)  # Plot Node Numbers
        ...
        NSV_load_names1=Normalspurbahnverkehr_load_generator(mdl,name='Gleis1', l_Pl=L_el, h_Pl=t_p, s=s*b1, beta=beta,
        ...
        earth_pressure_liveload1 = earthPressure_liveload_generator(structure=mdl, s=s*b1, beta=beta, L=L_el, h_w=h_w, t_p=t_p, phi_k=phi_k, gamma_Q=1.45, direction='all', name="track1")


        #Load Steps
        dead_loads=['load_gravity']
        superimposed_dead_loads = earth_pressure_gravel_load+ earth_pressure_backfill_load + NSV_dead_loads1 #+gravel_pressure 
        live_loads = NSV_live_loads1 + earth_pressure_liveload1 
