...
#                                                        gamma_G=1.35, gamma_Q=1.45, direction='all', verbalise=True)
    ...
    earth_pressure_liveload1 = earthPressure_liveload_generator(structure=mdl, s=s1*b1, beta=beta1, L=L_el, h_w=h_w, t_p=t_p, phi_k=phi_k, gamma_Q=1.45, direction='negative', name="track1")
    ...
    superimposed_dead_loads = earth_pressure_gravel_load+ earth_pressure_backfill_load + NSV_dead_loads1 #+ NSV_dead_loads2  
