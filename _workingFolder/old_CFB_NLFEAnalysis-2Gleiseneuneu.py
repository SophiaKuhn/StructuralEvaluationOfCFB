...
#    plot_nr_nodes(mdl)  # Plot Node Numbers
    ...
    earth_pressure_liveload1 = earthPressure_liveload_generator(structure=mdl, s=s1,beta=beta1, L=L_el, h_w=h_w, t_p=t_p, phi_k=phi_k, direction='negative', gamma_Q=1.45, name='Gleis1')

    earth_pressure_liveload2 = earthPressure_liveload_generator(structure=mdl, s=s2,beta=beta2, L=L_el, h_w=h_w, t_p=t_p, phi_k=phi_k, direction='negative', gamma_Q=1.45, name='Gleis2')
