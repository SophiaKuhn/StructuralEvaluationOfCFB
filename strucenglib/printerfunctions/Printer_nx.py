...
for variabel in variabeln:
    ...
    if variabel == "spezial":
        ...
        legende = ["$v_x$ = 100 kN/m", "$v_x$ = 200 kN/m", "$v_x$ =  300 kN/m", "$v_x$ =  400 kN/m",
                   "$v_x$ =  0 kN/m", ]  # vx
    ...
    settext = ["Mindestbewehrung: Aus - Druckzoneniteration: Aus - Schubnachweis: 'sia' ",
               "Mindestbewehrung: Aus - Druckzoneniteration: Aus - Schubnachweis: 'vereinfacht'", "FALSCH"]
    j = 0
    for se in sets:
        print('\t' + setname[j])
        ...
        for resultat in resultate:
            ...
            for xx in x:
                ...
                inp1 = [1, mx[zahl], my[zahl], mxy[zahl], vx[zahl], vy[zahl],
                        ((vx[zahl] ** 2.0 + vy[zahl] ** 2.0) ** 0.5), (xx), ny[zahl], nxy[zahl], h[zahl], 40, 40,
